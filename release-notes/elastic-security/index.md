...
* Adds a `quick_export` toolbar option to dashboards, allowing you to export the current dashboard view as a PDF without opening the export menu [#999999]({{kib-pull}}999999).
